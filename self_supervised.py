...
def get_args():
	...
	parser.add_argument('--batch_size', type=int, default=128, help='Batch size for training') #modified number
...
def get_dataset_config(args, augmentations):
	dataset = {
		'root_dir': '/Users/MAC/Downloads/SignFi Dataset/' if args.database_path is None else args.database_path,
...
def main(cfg):
	...
	model = SSLModel(cfg)
#commented out since mps doesn't support doubles
